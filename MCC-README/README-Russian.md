...
[Документация](https://mccteam.github.io/) | [Скачать](#download) | [Установка](https://mccteam.github.io/guide/installation.html) | [Конфигурация](https://mccteam.github.io/guide/configuration.html) | [Использование](https://mccteam.github.io/guide/usage.html)
...
**Консольный майнкрафт клиент (MCC)** — лёгкий кроссплатформенный клиент с открытым исходным кодом для версии **Java**, позволяющей подключаться к любому серверу Minecraft, отправка команд и получение текстовых сообщений быстрым и простым способом без открытия основной игры Minecraft.
...
Чтобы улучшить перевод для MCC, посетите [Crowdin - Консольный майнкрафт клиент](https://crwd.in/minecraft-console-client).
