...
Holen Sie sich die neueste Version im [Releases-Bereich](https://github.com/MCCTeam/Minecraft-Console-Client/releases/latest).

## Schnelle Installation ⚡

Öffne ein Terminal in dem Ordner, in dem sich MCC befinden soll, und führe folgenden Befehl aus:
...
Das Skript erkennt Ihre Architektur und lädt die passende Binärdatei herunter. Weitere Optionen (einschließlich `wget` und manueller Downloads) findest du im [Installationsleitfaden](https://mccteam.github.io/guide/installation.html).
...
Um die Übersetzungen für MCC zu verbessern, besuchen Sie bitte: [Crowdin - Minecraft Console Client](https://crowdin.com/project/minecraft-console-client).
...
## Verwendet Technologien von
<div align="center">
<a href="https://sentry.io/welcome/">
  <img src="https://github.com/breadbyte/Minecraft-Console-Client/assets/14045257/411e9a2f-cd9b-4bb5-b7e9-cd7529c76b88" alt="Wächter"  />
</a>
</div>
